  ...
  return (
    <SiteShell activeNav="home">
      <div className="breadcrumb-bar">
        ...
        <Link href="/account">My Account</Link> <span className="sep">&rsaquo;</span> <span>Edit Billing Address</span>
      </div>
      <div className="main-content">
        <div className="account-layout">
          ...
          <div className="account-main">
            ...
            <LegacyScriptForm id="billingForm" handler="handleSave">
              ...
              <div className="form-row">
                <label>Street</label>
                <input type="text" defaultValue="123 Main St" required />
              </div>
              <div className="form-row">
                <label>City</label>
